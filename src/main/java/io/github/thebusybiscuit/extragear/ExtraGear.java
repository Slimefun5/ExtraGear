...
public class ExtraGear extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        itemGroup = new ItemGroup(new io.github.thebusybiscuit.slimefun5.libraries.keys.NamespacedKey("extragear", "items"), CustomItemStack.create(Material.DIAMOND_SWORD, "\u00a76ExtraGear"), 1);
